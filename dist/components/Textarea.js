...
`;
export const Textarea = ({ variant = "default", error = false, success = false, warning = false, className, ...props }) => {
    return (_jsx(StyledTextarea, { "$variant": variant, "$error": error, "$success": success, "$warning": warning, className: className, ...props }));
};
